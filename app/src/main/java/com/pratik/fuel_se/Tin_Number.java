...
public class Tin_Number extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tin__number);
        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        backbutton = (Button) findViewById(R.id.backbutton3);
        camera1 = (Button) findViewById(R.id.photo3);
        gallary1 = (Button) findViewById(R.id.gallery3);
        pan = (ImageView) findViewById(R.id.tin);
