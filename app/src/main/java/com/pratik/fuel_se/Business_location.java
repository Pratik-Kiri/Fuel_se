...
public class Business_location extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        camera1 = (Button) findViewById(R.id.photo5);
        gallary1 = (Button) findViewById(R.id.gallery5);
        pan = (ImageView) findViewById(R.id.businesslocation);
